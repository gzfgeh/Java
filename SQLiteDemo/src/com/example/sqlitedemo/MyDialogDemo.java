...
public class MyDialogDemo extends Dialog{
	...
	public static class Builder{
		...
		public MyDialogDemo create(int layoutXml) {
                ...
                }else if ((layoutXml == R.layout.input_dialog) || (layoutXml == R.layout.delete_dialog) || (layoutXml == R.layout.find_dialog)){
                	if (positiveButtonText != null) {
                        ((Button) layout.findViewById(R.id.sure)).setText(positiveButtonText);
                        if (positiveButtonClickListener != null) {
                                ((Button) layout.findViewById(R.id.sure))
                ...
                else if((layoutXml == R.layout.insert_dialog) || (layoutXml == R.layout.update_dialog)){
                	if (positiveButtonText != null) {
                        ((Button) layout.findViewById(R.id.sure)).setText(positiveButtonText);
                        if (positiveButtonClickListener != null) {
                                ((Button) layout.findViewById(R.id.sure))
                                                .setOnClickListener(new View.OnClickListener() {
                                                        public void onClick(View v) {
                                                                positiveButtonClickListener.onClick(dialog,
                                                                                DialogInterface.BUTTON_POSITIVE);
                                                                mListener.getText(((EditText)layout.findViewById(R.id.insert_name)).getText().toString()+
                                                                		" " + ((EditText)layout.findViewById(R.id.insert_phone)).getText().toString()+
                                                                		" " + ((EditText)layout.findViewById(R.id.insert_account)).getText().toString());
                                                                }
                                                });
                        }
                	}
